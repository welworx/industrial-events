...
Conference list by year:

- https://welworx.github.io/conferences/conferences.md

Split conference lists:

- `https://welworx.github.io/conferences/conferences/series/<series-slug>.md`
- `https://welworx.github.io/conferences/conferences/category/<category-slug>.md`
- `https://welworx.github.io/conferences/conferences/domain/<domain-slug>.md`
- `https://welworx.github.io/conferences/conferences/group/<group-slug>.md`
...
- `public/conferences.md` lists submission opportunities, upcoming events, date-TBD announcements, and past events with links to official pages.
- `public/conferences/<split>/<slug>.md` contains the same Markdown structure filtered by series, category, domain, or co-located group.
